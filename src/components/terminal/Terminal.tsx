...
const Terminal: React.FC = () => {
  ...
  useEffect(() => {
    if(start) {
      document.addEventListener("keydown", function (event) {
        if (event.key === "Enter") {
          if (!Text3.includes("Access")) {
            ...
            setText1("ssh heykash876");
            setText2("heyakash876's password:");
            setText3("Access Granted!");
          }
          ...
          if (CommandArea) {
            ...
            if(previousCommand.length>0) {
              setprevusedCommand(prevArray => [...prevArray, "guest@heyakash:~$ " + previousCommand]);
      ...
      Typewriter({ text: "ssh guest@heyakash", delay: 100, func: setText1 });

      setTimeout(() => {
        setText2("guest@heyakash's password:▮");
      }, 3000);
      ...
      setTimeout(() => {
        setText3("Connecting to heyakash876...");
      }, 4300);

      setTimeout(() => {
        setText2("guest@heykash's password:");
        setText3("> Access granted.");
      }, 7300);
    }
  }, [start]);
  ...
  return (
    <div className="bg-skills">
      ...
      `}
            ...
            {Text3.includes("Access") ? <span><span style={{ color: "#c9c9c9" }}>General: </span> about, all links, clear</span> : ""}
                ...
                if (item.match(new RegExp(`\\b${"discord"}\\b`, "g"))) {
                  return (
                    <div  className="mcq-wrapper">
                      ...
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Discord: <a href="https://discord.com/users/760081488216719381" rel="noreferrer" target="_blank">cashhh ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div  className="mcq-wrapper">
                      <li className="userPrefix" key={index}>{item}</li>
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Github: <a href="https://github.com/heyakash876" rel="noreferrer" target="_blank">@heyakash876 ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div  className="mcq-wrapper">
                      <li className="userPrefix" key={index}>{item}</li>
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Email: <a href="mailto:vermakash876@gmail.com" rel="noreferrer" target="_blank">vermakash876@gmail.com ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div  className="mcq-wrapper">
                      <li className="userPrefix" key={index}>{item}</li>
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Twitter: <a href="https://twitter.com/vermakash876" rel="noreferrer" target="_blank">@vermakash876  ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div  className="mcq-wrapper">
                      <li className="userPrefix" key={index}>{item}</li>
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Telegram: <a href="https://t.me/hey_cash876" rel="noreferrer" target="_blank">@hey_cash876  ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div><li className="userPrefix" key={index}>{item}</li>
                      ...
                      <div className="mcq-wrapper"><br></br>
                        <ul id="mcq" className="mcq">
                          <li className="mcq-option" tabIndex={0}><a href="https://github.com/heyakash876" target='_blank' rel="noreferrer">My Github: @heyakash876 ↗</a></li>
                          <li className="mcq-option" tabIndex={1}><a href="mailto:vermakash876@gmail.com" target='_blank' rel="noreferrer">My Email:vermakash876@gmail.com↗</a></li>
                          <li className="mcq-option" tabIndex={2}><a href="https://twitter.com/vermakash876" target='_blank' rel="noreferrer">My Twitter: @vermakash876 ↗</a></li>
                          <li className="mcq-option" tabIndex={3}><a href="https://t.me/hey_cash876" target='_blank' rel="noreferrer">My Telegram: @hey_cash876 ↗</a></li>
                          <li className="mcq-option" tabIndex={4}><a href="https://discord.com/users/760081488216719381" target='_blank' rel="noreferrer">My Discord: cashhh ↗</a></li>
                        </ul>
                      </div><br />
                    </div>
                  );
                ...
                // }
                  ...
                  return (
                    <div>
                      <li className="userPrefix" key={index}>{item}</li>
                      <div className='aboutme'><br></br>
                      Hi, nice to meet you. I'm Akash, blockchain and web developer .
                        <br></br><br></br>
                       I am passionate about the blockchain industry and believe it has the potential to change the word for better. 
                        <br></br><br></br>
                      </div>
                    </div>
                  );
            ...
            {Text3.includes("Access") ? <span className='commands'><span className='userPrefix'>guest@heyakash:~$</span> <input type="text" id="command" name="command" autoFocus></input></span> : ""}
          </div>
        ):(
